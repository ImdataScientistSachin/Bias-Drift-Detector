...
[![Tests Pipeline](https://github.com/ImdataScientistSachin/Bias-Drift-Detector/actions/workflows/ci.yml/badge.svg)](https://github.com/ImdataScientistSachin/Bias-Drift-Detector/actions)
...
This project is licensed under the MIT License - see the [LICENSE](LICENSE) file for details. You are free to use, modify, and distribute this software under its terms.
